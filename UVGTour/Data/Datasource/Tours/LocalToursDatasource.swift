        ...
        Tour(
            ...
            stops: [
                Stop(
                    ...
                    """,
                    emoji: "🐲",
                    sensorId: "4056668d19dfe5fab47c9e83c82a982b", nextStopDirection: .pi/2, imageName: nil // osete
                    
                ),
                Stop(name: "waypoint01", description: "Just a waypoint", emoji: "📚", sensorId: "testwaypoint", nextStopDirection: .pi/4, imageName: nil, isWaypoint: true), // norte,
                Stop(name: "Biblioteca", description: "Biblioteca de la UVG.", emoji: "📚", sensorId: "8cc2e0a06f1666b863df2ea773e7ad02", nextStopDirection: 0, imageName: nil), // norte
